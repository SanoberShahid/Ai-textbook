...
class FastEmbeddingGenerator:
    ...
    def __init__(self, model_name: str = "all-MiniLM-L6-v2", device: str = None):
        ...
        # Use 'cpu' if device is None or empty string
    ...
    def _load_model(self):
        ...
        try:
            logger.info(f"Loading sentence-transformer model: {self.model_name} on device: {self.device or 'auto'}")
    ...
    def generate_embedding(self, text: str, task_type: str = "retrieval_document", normalize: bool = True) -> List[float]:
        ...
        try:
            ...
            logger.info(f"Generated embedding for task type: {task_type}, text length: {len(text)}")
            return embedding
        except Exception as e:
    ...
    def generate_embeddings_batch(self, texts: List[str], task_type: str = "retrieval_document", normalize: bool = True, batch_size: int = 32) -> List[List[float]]:
        ...
        try:
            ...
            logger.info(f"Generated embeddings for {len(texts)} texts, task type: {task_type}")
