"""
Simple debug script for the RAG pipeline
"""
...
def debug_rag_simple():
    """Debug the RAG pipeline with simple logging."""
    print("=== Simple RAG Pipeline Debug ===\n")
    ...
    try:
        ...
        print(f"OK: Found {len(search_results)} results from Qdrant")
    ...
    try:
        ...
        print(f"OK: Formatted context from {len(context_parts)} results")
        ...
        if response.status_code == 200:
            ...
            if api_key:
                ...
                try:
                    ...
                    print(f"OK: GenAI is working, test response: {str(test_response.text)[:100]}...")
                except Exception as e:
                    print(f"ERROR: GenAI test failed: {e}")
                    import traceback
                    traceback.print_exc()
            else:
