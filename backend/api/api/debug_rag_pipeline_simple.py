...
def debug_rag_pipeline():
    ...
    print(f"OK: Qdrant client initialized with URL: {qdrant_url}")
    ...
    try:
        ...
        if len(search_results) > 0:
            ...
            print("WARNING: No results found - the collection might be empty or have no relevant content")
    ...
    if os.path.exists(docs_dir):
        print(f"OK: Docs directory exists: {docs_dir}")
